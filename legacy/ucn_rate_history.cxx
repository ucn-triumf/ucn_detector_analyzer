// Analyzer
// This analyzer will calculate the UCN rate per second and then put that data into the ODB.  Need to check and create all the relevant ODB variables to put the data into.
//  T. Lindner, Nov 2017
